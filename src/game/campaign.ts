...
export const LADDER: Opponent[] = [
  ...
  },
  {
    id: 'c5',
    name: 'Thicket',
    title: 'of the Still Water',
    blurb: 'Big bodies that regrow what you chip off. Burst it down or you will be there all day.',
    champion: 'celebi',
    difficulty: 'normal',
    deck: ['tangrowth', 'serperior', 'lapras', 'rotomwash', 'rotommow', 'quagsire', 'carracosta', 'chansey'],
    summons: ['hooh', 'kyogre'],
  },
  {
    id: 'c6',
    name: 'Quill',
    title: 'the Swarm',
    blurb: 'Everything moves further than you expect and hits before you are set.',
    champion: 'jirachi',
    difficulty: 'hard',
    deck: ['scyther', 'accelgor', 'escavalier', 'luxray', 'primeape', 'gallade', 'beartic', 'weavile'],
    summons: ['palkia', 'lugia'],
  },
  {
    id: 'c7',
    name: 'Hex',
  ...
  },
  {
    ...
    name: 'Pyre',
    title: 'the Long Burn',
    blurb: 'Heavy hitters with reach. Nothing here dies to one attack, and nothing here misses.',
    champion: 'victini',
    difficulty: 'hard',
    deck: ['magmortar', 'chandelure', 'blaziken', 'krookodile', 'rhyperior', 'mamoswine', 'arcanine', 'houndoom'],
    summons: ['dialga', 'groudon'],
  },
  {
    id: 'c9',
    name: 'Sovereign',
